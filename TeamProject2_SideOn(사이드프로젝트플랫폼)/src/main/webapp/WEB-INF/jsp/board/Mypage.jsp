...
<div class="MyProfile">
    ...
    <input style="margin-top:30px;" type="button" class="button" value="프로필 보기" onclick="location.href='/member/myInfo'" >
</div>
<div class="MyProfile">
    <div class="Img"><a href="#">
    ...
    <div class="expalin"> 회원님의 모집, 지원 현황을 관리할 수 있습니다.</div> 
    <input style="margin-top:30px;" type="button" class="button" value="프로젝트 관리" onclick="location.href='/recruit/recruitMyApply'" >
</div>
...
<div class="MyProfile">
    ...
    <input style="margin-top:30px;" type="button" class="button" value="문의하기" onclick="location.href='FaQBoard'"> 
</div>
<div class="MyProfile">
    ...
    <input style="margin-top:30px;" type="button" class="button" value="탈퇴하기" onclick="location.href='/member/deleteForm'" >
