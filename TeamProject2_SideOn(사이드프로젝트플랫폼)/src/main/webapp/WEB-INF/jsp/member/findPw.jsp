...
<head>
    ...
    function findPw() {
    	...
    	//이름  입력데이터 가져오기
    	var name = document.getElementById('memberId').value;
    	 console.log(name);
    	//핸드폰 입력데이터 가져오기
...
<body class="" style="background-color: #FFD026">
 ...
 <form  action="/member/findPwComplete" name="findPwForm" id="findPwForm" method="post">
                                        <div class="form-group" style="margin-top: 5%">
                                            <input type="text" class="form-control form-control-user"
                                                id="memberId" name="memberId" aria-describedby="name"
                                        ...
                                        <input type="button" value="확인" class="btn btn-primary btn-user btn-block" onclick="findPw();">
